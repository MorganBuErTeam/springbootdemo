...
public class HttpClient{
	...
	private Integer connectTimeout = 5000;// 创建连接的最长时间
	private Integer connectionRequestTimeout = 5000;// 从连接池中获取到连接的最长时间
	private Integer socketTimeout = 30000;// 数据传输的最长时间
