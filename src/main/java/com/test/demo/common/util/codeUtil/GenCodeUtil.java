package com.test.demo.common.util.codeUtil;
...
//        sb.append("import "+extendsBasePackage+".dao.GenericDao;\n\n");
        sb.append("import "+businessPackage+".domain."+beanName+";\n");
//        sb.append("import "+businessPackage+".entity."+queryModelName+";\n\n");
        sb.append("/**\n *@author "+author+"\n **/\n");
//        sb.append("public interface "+beanName+"Mapper extends GenericDao<"+beanName+", "+queryModelName+"> {\r\n"); //todo 继承mapper
        sb.append("public interface "+beanName+"Mapper{");
        sb.append("\n\t\n}");
        return sb.toString();
    }
    /**
    ...
    public static void genFiles(String author, String tableName, String extendsBasePackage, String basePackage, String mybatisBasePath,  String beanName, String queryModelName, String properitesUri) throws IOException {
        ...
        String entityPath = createFloder("src/main/java", packagePath+"/domain");
        //生成实体类文件
        ...
        fos.write(genJavaBeanFromTableStructure(author, table, beanName, basePackage+".domain").getBytes());
        fos.close();
        //生成查询实体类文件
...
//        }
        ...
        fos = new FileOutputStream(mybatisPath+"/"+toFirstCharUpCase(beanName)+"Mapper.xml");
        ...
        File fDao = new File(daoPath+"/"+beanName+"Mapper.java");
...
//        fos.close();
    ...
    public static void main(String[] args) throws IOException {
        genFiles("morgan", "PIM", "","com.test.demo", "/resources/mapper","Pim", "", "application-dev.yml");
    }
