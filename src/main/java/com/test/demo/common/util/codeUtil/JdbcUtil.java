...
public class JdbcUtil {
	...
	public static Connection getConnection(){
		try {
			...
			properties.put("password", "MORGANABC");
			properties.put("remarksReporting","true");//想要获取数据库结构中的注释，这个值是重点
			return DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/springbootdemo?useUnicode=true&characterEncoding=UTF8", properties);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
