...
J.exend( calendar.prototype, {
	...
	createbody: function(d,m)
	{
		...
		J(chead).stcs({ width: '260px', height: '40px' ,'line-height': '40px' ,background:'#3366CC',color:'fff'}).html(txt); J(m).apch(chead);
...
//			  +'<div id="foot"><span id="t1">今天</span><span id="t2">' + new Date().toLocaleDateString() + '</span></div>'
		...
		var cbody = J(d).crte('div'); J(cbody).stcs('width','260px').html(txt); J(m).apch(cbody);
